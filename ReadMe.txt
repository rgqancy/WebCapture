========================================================================
		ActiveX Control DLL : WEBCAPTURE
========================================================================

ControlWizard has created this project for your WEBCAPTURE ActiveX Control
...
that make up your WEBCAPTURE ActiveX Control DLL.
...
WebCaptureCtl.h
	This file contains the declaration of the CWebCaptureCtrl C++ class.

WebCaptureCtl.cpp
	This file contains the implementation of the CWebCaptureCtrl C++ class.

WebCapturePpg.h
	This file contains the declaration of the CWebCapturePropPage C++ class.

WebCapturePpg.cpp
	This file contains the implementation of the CWebCapturePropPage C++ class.

WebCaptureCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CWebCaptureCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file WebCapture.rc.
